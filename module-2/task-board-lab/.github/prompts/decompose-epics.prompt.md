...
You are decomposing an existing PRD into a small set of high-impact Epics for this repository.
...
3. Identify **3 to 4** high-level Epics that collectively cover the PRD scope.
4. Each Epic must:
...
7. If `specs/epics/` does not exist, create it.
